      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid md:grid-cols-5 gap-8">
          <div className="col-span-1 md:col-span-2 space-y-6">
            ...
            <div className="pt-2">
              <p className="text-xs text-gray-700 font-medium border-l-2 border-[#51b052] pl-3">
                Strategic Initiative under Resolution 259/NQ-CP<br/>
                Creating Vietnam&apos;s Global Financial Center
              </p>
            </div>
            <div className="flex gap-4">
              <a href="https://www.linkedin.com/company/110184383" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-900 hover:bg-[#51b052] hover:text-white transition-all duration-300 cursor-pointer">
        ...
        <div className="border-t border-gray-300 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-700 flex gap-4 flex-wrap">
